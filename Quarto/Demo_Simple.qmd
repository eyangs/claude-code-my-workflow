...
::: definition
**Definition:** Causal inference is process of drawing conclusions 
about causal relationships based on observed data
[@Angrist2009_mostly_harmless].
:::

::: keybox
**Key Question:** What would have happened to Y if we had 
changed X by one unit, while holding everything else constant?
:::
...
**Example:** Does taking a drug actually cure a disease, 
...
We cannot observe $Y_{1i}$ and $Y_{0i}$ simultaneously 
for the same unit $i$.
:::
